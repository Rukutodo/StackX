...
export default function AfterPurgePage() {
  return (
    <div className="min-h-screen bg-background pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold mb-6 italic underline decoration-primary/30">AfterPurge</h1>
          <p className="text-xl text-muted max-w-2xl mx-auto mb-10">AfterPurgeAfterPurge</p>
          <div className="p-12 rounded-3xl glass-card border-white/5 bg-white/[0.02] text-left">
            ...
            <p className="text-muted leading-relaxed">This page was automatically generated for the <strong>AfterPurge</strong> service.</p>
          </div>
